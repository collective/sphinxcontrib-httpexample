...
snapshots['test_fixture[build_plone_javascript_command-fixture_003] 1'] = '''createAliasesMutation
|
const aliasesData = '{
  "title": "My New Document Title"
}';'''
...
snapshots['test_fixture[build_plone_javascript_command-fixture_013] 1'] = '''createAliasesMutation
|
const aliasesData = 'grant_type=urn:ietf:params:oauth:grant-type:jwt-bearer&assertion=REDACTED';'''

snapshots['test_fixture[build_plone_javascript_command-fixture_014] 1'] = '''createAliasesMutation
|
